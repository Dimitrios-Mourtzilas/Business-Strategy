...
class Ui_About(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.about_window_icon = QtGui.QPixmap('app_smaller_logo.png')
        ...
        print(os.path.abspath("app_smaller_logo.png"))
        self.path = os.path.abspath("images/app_smaller_logo.png")
        self.bool = re.match("images/",self.path)
        print(self.bool)
        self.smaller_icon_logo = QtGui.QPixmap(os.path.abspath("app_smaller_logo.png"))
